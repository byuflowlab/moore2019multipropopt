...
# function optimize(numprops,to_factor,db_factor)
    ...
    p_chord = [0.10877, 0.105743, 0.152789, 0.05]
    p_twist_d = [36.8235, 42.9044, 39.6085, 45.0]
    p_pitch_d_accel = -19.82051083412791
    p_pitch_d_climb = -20.188093719254248
    p_pitch_d_cruise = 12.113489425294997
    velocity_accel = 16.525742913704143
    velocity_climb = 20.494356096152448
    p_Rtip = 0.3352916814504692
    p_rpm_accel = 2798.6019520339005
    p_rpm_climb = 3906.0184495335675
    p_rpm_cruise = 1937.9861230380968
    kv = 7.283787837965981
    i0 = 3.246244436771027
    w_aoa_d_accel = 33.56793200298914
    w_aoa_d_climb = 17.149964223958825
    w_aoa_d_cruise = 4.6635813147838405
    batt_mass_accel = 0.001
    batt_mass_climb = 1.8299675145048462
    batt_mass_cruise = 124.65256349906039

    p_lam_t = [0.000152, 0.000152, 0.000154056, 0.000152, 0.000218, 0.000218, 0.000218, 0.000218]
    p_chord = [0.166552, 0.0975438, 0.158812, 0.05]
    p_twist_d = [36.1394, 43.9595, 39.3576, 44.9413]
    p_pitch_d_accel = -19.82051083412791
    p_pitch_d_climb = -19.673931974404663
    p_pitch_d_cruise = 12.113489425294997
    velocity_accel = 16.525742913704143
    velocity_climb = 17.92453072013977
    p_Rtip = 0.33358244398851317
    p_rpm_accel = 2798.6019520339005
    p_rpm_climb = 3982.97243760044
    p_rpm_cruise = 1937.9861230380968
    kv = 7.283787837965981
    i0 = 3.246244436771027
    w_aoa_d_accel = 33.55720131194915
    w_aoa_d_climb = 19.060521666106922
    w_aoa_d_cruise = 4.625279599698307
    batt_mass_accel = 0.001
    batt_mass_climb = 0.7513826889091813
    batt_mass_cruise = 120.56189810246892

    #Fixed aoa

    p_lam_t = [0.000153579, 0.000178663, 0.0001561, 0.000152133, 0.000219456, 0.00024454, 0.000219456, 0.000218069]
p_chord = [0.0103954, 0.0933713, 0.0599442, 0.00461442]
p_twist_d = [41.6227, 24.3717, 14.3695, 13.163]
p_pitch_d_accel = -3.2690534912447027
p_pitch_d_climb = -2.540609477851697
p_pitch_d_cruise = 15.691671550603166
velocity_accel = 14.773922536312782
velocity_climb = 15.739203297656372
p_Rtip = 0.2864810438450941
p_rpm_accel = 4609.82392262001
p_rpm_climb = 4711.643437660769
p_rpm_cruise = 4146.636565711972
kv = 26.503046505320462
i0 = 3.6227923624420786
w_aoa_d_accel = 21.956729466140768
w_aoa_d_climb = 21.95745360315214
w_aoa_d_cruise = 2.403461393541066
batt_mass_accel = 0.001
batt_mass_climb = 0.21638706686583686
batt_mass_cruise = 33.75163056140507

p_lam_t = [0.000152, 0.000152, 0.000152, 0.000152, 0.00610876, 0.000218, 0.00126016, 0.000218]
p_chord = [0.0386928, 0.533125, 0.181682, 0.0158237]
p_twist_d = [45.0, 45.0, 39.3596, 45.0]
p_pitch_d_accel = -14.54728159209255
p_pitch_d_climb = -5.09712267734103
p_pitch_d_cruise = 4.9432398249254845
velocity_accel = 15.995007804586294
velocity_climb = 26.337746356051145
p_Rtip = 0.2894664909371061
p_rpm_accel = 2838.0428401587606
p_rpm_climb = 2888.0282346627564
p_rpm_cruise = 2819.8657809246233
kv = 12.280133800577637
i0 = 4.163444277175689
w_aoa_d_accel = 24.233058848742544
w_aoa_d_climb = 15.737442232486915
w_aoa_d_cruise = 4.444439650405827
batt_mass_accel = 0.001
batt_mass_climb = 0.01
batt_mass_cruise = 122.25583539648244

#fixed aoa
p_lam_t = [0.000304, 0.000304, 0.000304, 0.000152, 0.00747408, 0.000218, 0.000218, 0.000218]
p_chord = [0.0747408, 0.259543, 0.129903, 0.0746083]
p_twist_d = [45.0, 33.9765, 32.1005, 21.4489]
p_pitch_d_accel = -10.926405266200044
p_pitch_d_climb = -0.2922100830675738
p_pitch_d_cruise = 7.169900638226956
velocity_accel = 13.248574848003196
velocity_climb = 11.186861392297175
p_Rtip = 0.33529411764706596
p_rpm_accel = 3487.1663181567806
p_rpm_climb = 3048.3166788543012
p_rpm_cruise = 2935.6872224493186
kv = 11.814355271101915
i0 = 5.276596488003492
w_aoa_d_accel = 27.73121918047809
w_aoa_d_climb = 31.341939857883585
w_aoa_d_cruise = 4.75539301545378
batt_mass_accel = 0.001
batt_mass_climb = 1.4921603111606743
batt_mass_cruise = 123.82667345228165


#Fixed Structure
p_lam_t = [0.000304, 0.000304, 0.000304, 0.000152, 0.00543983, 0.000218, 0.000218, 0.000218]
p_chord = [0.075743, 0.245042, 0.109748, 0.0827292]
p_twist_d = [45.0, 33.3896, 32.6272, 21.9648]
p_pitch_d_accel = -15.021248505456517
p_pitch_d_climb = -1.8785934695356281
p_pitch_d_cruise = 7.223164185543996
velocity_accel = 10.524726663168186
velocity_climb = 11.415673816456872
p_Rtip = 0.33529411764705663
p_rpm_accel = 4394.002426218623
p_rpm_climb = 3331.0167793484025
p_rpm_cruise = 2940.3915925994443
kv = 9.911454715733731
i0 = 4.746176144671502
w_aoa_d_accel = 32.2780019035266
w_aoa_d_climb = 30.59415847598081
w_aoa_d_cruise = 4.767633198074562
batt_mass_accel = 0.001
batt_mass_climb = 1.2719969823699695
batt_mass_cruise = 122.94172253265747
...
#     x0[1:length(xwarm)] = xwarm[1:end]
    ...
    af = JLD.load("$(path)/airfoils/p8_cr$(round(Int,required_cruise/0.447))_db65af.jld")
    af = af["af"]
