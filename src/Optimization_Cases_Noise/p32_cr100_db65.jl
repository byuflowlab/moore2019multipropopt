...
# function optimize(numprops,to_factor,db_factor)
    ...
    #fixed aoa
    p_lam_t = [0.000152, 0.000152, 0.000152, 0.000152, 0.000218, 0.000218, 0.000218, 0.000218]
    p_chord = [0.0583285, 0.0863059, 0.0188193, 0.142403]
    p_twist_d = [45.0, 29.8139, 28.9127, 21.496]
    p_pitch_d_accel = -11.541667642140034
    p_pitch_d_climb = -10.69204892901169
    p_pitch_d_cruise = 13.831121522979261
    velocity_accel = 5.3459783104328045
    velocity_climb = 7.1928843845357315
    p_Rtip = 0.17269936339274694
    p_rpm_accel = 14448.856730516118
    p_rpm_climb = 14307.53058098444
    p_rpm_cruise = 5919.663257904192
    kv = 5.0
    i0 = 0.68802135652192
    w_aoa_d_accel = 29.834112427260102
    w_aoa_d_climb = 28.21872257338955
    w_aoa_d_cruise = 4.117987661394461
    batt_mass_accel = 0.001
    batt_mass_climb = 2.6873793547129035
    batt_mass_cruise = 115.37038585282313

# Fixed structure
p_lam_t = [0.000152, 0.000152, 0.000152, 0.000152, 0.000218, 0.000218, 0.000218, 0.000218]
p_chord = [0.085456, 0.0654303, 0.0175514, 0.144177]
p_twist_d = [44.8058, 28.8577, 29.8378, 26.95]
p_pitch_d_accel = -12.596670545966566
p_pitch_d_climb = -12.491647191848084
p_pitch_d_cruise = 13.84539049155311
velocity_accel = 5.555700577010318
velocity_climb = 7.111085104970282
p_Rtip = 0.1727272727272728
p_rpm_accel = 14389.852324307652
p_rpm_climb = 15024.276221562995
p_rpm_cruise = 5920.508865951474
kv = 5.768559669279809
i0 = 0.9373406594105673
w_aoa_d_accel = 30.353160282193386
w_aoa_d_climb = 30.786104499726893
w_aoa_d_cruise = 4.202232390010318
batt_mass_accel = 0.001
batt_mass_climb = 2.4346982940589954
batt_mass_cruise = 131.92874470711624
