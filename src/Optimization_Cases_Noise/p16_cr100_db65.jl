...
# function optimize(numprops,to_factor,db_factor)
    ...
    #fixed aoa
    p_lam_t = [0.000152, 0.000152, 0.000152, 0.000152, 0.000218, 0.000218, 0.000218, 0.000218]
    p_chord = [0.245832, 0.151065, 0.215252, 0.00330589]
    p_twist_d = [44.9553, 44.7723, 39.763, 35.4289]
    p_pitch_d_accel = -17.119535663774073
    p_pitch_d_climb = -18.86325194113396
    p_pitch_d_cruise = 12.188852148839478
    velocity_accel = 10.33973124690473
    velocity_climb = 11.414183380332755
    p_Rtip = 0.33464652516372956
    p_rpm_accel = 3479.6203703807205
    p_rpm_climb = 4027.782165098945
    p_rpm_cruise = 2005.6674231375896
    kv = 6.8377513408503345
    i0 = 5.62421103446519
    w_aoa_d_accel = 31.045338222261663
    w_aoa_d_climb = 31.111501758270723
    w_aoa_d_cruise = 4.571412690280962
    batt_mass_accel = 0.001
    batt_mass_climb = 1.4298560316313684
    batt_mass_cruise = 123.12818066473231


#Fixed Structure
    p_lam_t = [0.000152, 0.000152, 0.000152, 0.000152, 0.000218, 0.000218, 0.000218, 0.000218]
    p_chord = [0.331875, 0.172737, 0.188947, 0.0604996]
    p_twist_d = [45.0, 44.9984, 39.2274, 33.4651]
    p_pitch_d_accel = -17.739723142092807
    p_pitch_d_climb = -19.866433949282655
    p_pitch_d_cruise = 12.207299778102255
    velocity_accel = 9.35980769395562
    velocity_climb = 10.954220855900772
    p_Rtip = 0.3352825168491623
    p_rpm_accel = 3870.750973853234
    p_rpm_climb = 4465.220502390955
    p_rpm_cruise = 2018.8999568369097
    kv = 5.488335414716106
    i0 = 3.4135959940357545
    w_aoa_d_accel = 30.96513352623202
    w_aoa_d_climb = 31.473921485744206
    w_aoa_d_cruise = 4.5826801457815405
    batt_mass_accel = 0.001
    batt_mass_climb = 1.019710683247822
    batt_mass_cruise = 118.00741722086346
